...
public enum TeamOffence { OneTimer, WristShot, SlapShot, Pass, Carry };
public enum TeamDefence { BlockShot, PokeCheck, Check, InterceptPass, Positioning };
public class Team
{
    ...
    public TeamOffence teamOffence;
    public TeamDefence teamDefence;
